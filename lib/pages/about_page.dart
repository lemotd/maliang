                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              _buildLogItem(isDark, '修复', '自定义模型无法正常调用的问题'),
                              const SizedBox(height: 10),
                              _buildLogItem(isDark, '修复', '部分场景应用出现多个后台的问题'),
                              const SizedBox(height: 10),
                              _buildLogItem(isDark, '修复', '详情页超长图片显示异常'),
                              const SizedBox(height: 10),
                              _buildLogItem(isDark, '修复', '详情页生成中状态偶现渲染花屏问题'),
                              const SizedBox(height: 10),
                              _buildLogItem(isDark, '修复', '部分页面手势提示条不沉浸的问题'),
                            ],
                          ),
                        ),
                      ),
